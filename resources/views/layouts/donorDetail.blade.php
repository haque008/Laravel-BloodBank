                    ...
                    <div class="card-body">
                        <div class="list-group">
                            ...
                            >{{$form->city}}
                             ...
                             <div class="" style=" font-size:22px;background:rgb(244,243,243);text-align:center;margin-bottom: 5px; color:rgb(53,59,72);font-weight: bolder;"
                                >{{$form->donorEmail}}
                                </div>
                            ...
                            <table style="text-align: center;">
                                <tr>
                                    ...
                                    <th style="text-align: center">Donating Date</th>
                                </tr>
                                <tr>
                                    ...
                                    <td style="font-family: 'Sky Text', sans-serif;font-size: 17px;">{{$form->donatingDate}}</td>
                                </tr>
