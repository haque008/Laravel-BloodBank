...
<head>
    ...
    <link rel="shortcut icon" class="fa fa-tint" href="{{ url('Icon.png') }}">
...
<header class="app-header navbar" style="background-color:rgb(228,42,32);">
    ...
    <ul class="nav navbar-nav hidden-md-down">
        ...
        <li class="nav-item px-1">
            @if(Auth::check())
                <a class="nav-link" href="{{ route('form.show',['id'=> Auth::user()->id])}}" style="color:  rgb(255,255,255); font-size: 16px;">My DashBoard</a>
            @endif
        </li>

        <li class="nav-item px-1">
            <a class="nav-link" href="{{route('requestList')}}" style="color:rgb(255,255,255); font-size: 16px;">Blood Request</a>
        </li>
                ...
                <li class="nav-item">
                    @if(Auth::check())
                        <a class="nav-link" href="{{route('search')}}">
                            <i class="fa fa-heartbeat" style="color: red;" aria-hidden="true"></i><h6 style="color: #fff8c5;">Search</h6>
                        </a>
                    @else
