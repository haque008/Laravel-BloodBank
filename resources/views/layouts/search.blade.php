...
<div class="col-md-10">
    ...
    <div class="container">
        ...
        @if(isset($details))
            <p>Available Donors  <b> {{ $query }} </b> are :<p>
                            ...
                            <div class="card table-borderer mb-3" style="max-width: 20rem;">
                                ...
                                <div class="card-body">
                                    <div class="list-group">
                                        ...
                                        <div  class=""style="text-align:center;background:rgb(244,243,243) ;color:rgb(53, 59, 72);font-size: 20px;font-weight: bold; font-family: 'Philosopher', sans-serif" >{{$forms->city}}
                                        </div>
